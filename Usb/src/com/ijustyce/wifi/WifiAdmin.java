...
private static final String TAG = "NanoWifiAdmin";
...
//			mWifiManager.saveConfiguration();
	...
	public void addNetwork(WifiConfiguration wcg) {
		...
		save1 = mWifiManager.enableNetwork(wcgID, true);
		save2 = mWifiManager.saveConfiguration();
	}
	
	public boolean getAddNetStatus(){
		return save1&&save2;
	}
	...
	public static final int TYPE_WPA2 = 0x14;
	...
	private synchronized void register() {
		Log.e(TAG, "register() ##mHaveRegister = " + mHaveRegister);
	...
	private synchronized void unRegister() {
		Log.e(TAG, "unRegister() ##mHaveRegister = " + mHaveRegister);
...
//		mTimer.schedule(mTimerTask, 0, 20 * 1000);// 20s
	...
	public WifiConfiguration createWifiInfo(String SSID, String password, int type) {
		...
		} else if (type == TYPE_WPA2) {   // WIFICIPHER_WPA2psk
			Log.e(TAG, "Type =4.");
			config.preSharedKey = "\"" + password + "\"";
	        config.hiddenSSID = true;
	...
	public int isWifiContected(Context context) {
		...
		Log.e(TAG, "isConnectedOrConnecting = " + wifiNetworkInfo.isConnectedOrConnecting());
		Log.e(TAG, "wifiNetworkInfo.getDetailedState() = " + wifiNetworkInfo.getDetailedState());
		if (wifiNetworkInfo.getDetailedState() == DetailedState.OBTAINING_IPADDR
			...
			Log.e(TAG, "getDetailedState() == " + wifiNetworkInfo.getDetailedState());
	...
	private WifiConfiguration IsExsits(String SSID) {
		...
		for (WifiConfiguration existingConfig : existingConfigs) {
			Log.e(TAG, "existingConfig() == " + existingConfig.SSID);
